...
var seuratUri = "uri:http://ultrastructure.me/ontology/com.chiralbehaviors/demo/seurat";
...
myApp
    ...
    [
        ...
        function ($scope, Restangular) {
            var Seurat = Restangular.one('/graphql').one('workspace').all(encodeURIComponent(seuratUri));
            ...
            $scope.loadOrders = function () {
                ...
                Seurat.post(request).then(function (result) {
